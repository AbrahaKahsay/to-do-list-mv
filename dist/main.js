...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Tasks\": () => (/* binding */ Tasks),\n/* harmony export */   \"addList\": () => (/* binding */ addList),\n/* harmony export */   \"display\": () => (/* binding */ display)\n/* harmony export */ });\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './icons/dots.png'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './icons/trash-bin.png'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\nObject(function webpackMissingModule() { var e = new Error(\"Cannot find module './icons/edit.png'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n\n\n\n\n// handles DoM elements\nconst addList = document.getElementById('add-list');\nconst newList = document.getElementById('new-list');\n\n// Create a class for tasks\nclass Tasks {\n    constructor(){\n        this.array = [];\n    }\n}\n\n// create display method to show on the DoM\nconst display = ()=>{\n    if(localStorage.Tasks) {\n        for(let i=0; i<JSON.parse(localStorage.Tasks).length; i+=1) {\n            // creating a div element to store form inputs\n            const div = document.createElement('div');\n\n            const todo = document.createElement('div');\n            todo.id = `item${i}`;\n\n            // create and append checkbox\n            const newCheck = document.createElement('input');\n            newCheck.setAttribute('type', 'checkbox');\n            newCheck.setAttribute('id', `${i}`);\n            todo.appendChild(newCheck);\n\n            // create and append label\n            const newLabel = document.createElement('input');\n            newLabel.setAttribute('type', 'text');\n            newLabel.className = 'list';\n            newLabel.id = `list${i}`;\n            newLabel.value = JSON.parse(localStorage.Tasks)[i].description;\n            todo.appendChild(newLabel);\n\n            // create and line breal \n            const lineBreak = document.createElement('br');\n            todo.appendChild(lineBreak);\n\n            // create and append line\n            const line = document.createElement('hr');\n            todo.appendChild(line);\n\n            const dotsIcon = new Image();\n            dotsIcon.className = 'icon';\n            dotsIcon.id = `icon${i}`;\n            dotsIcon.src = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './icons/dots.png'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());        // check .src later\n            div.appendChild(dotsIcon);\n\n            const trashIcon = new Image();\n            trashIcon.className = 'trashIcon';\n            trashIcon.id = `remove${i}`;\n            trashIcon.src = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './icons/trash-bin.png'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n            div.appendChild(trashIcon);\n            \n            const editIcon = new Image();\n            editIcon.className = 'iconEdit';\n            editIcon.src = Object(function webpackMissingModule() { var e = new Error(\"Cannot find module './icons/edit.png'\"); e.code = 'MODULE_NOT_FOUND'; throw e; }());\n            div.appendChild(editIcon);\n            \n            newList.appendChild(todo);\n            newList.appendChild(div);\n        }\n    }\n};\n\n\n//# sourceURL=webpack://to-do-list-mv/./src/modules/methods.js?");
